...
const Modal = ({ children }: IProp) => {
  ...
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          className=" modal px-3 max-h-[60%] h-[60%] w-[89%] md:w-2/5 bg-white dark:bg-neutral-700 md:bg-neutral-200 !z-[9999] rounded-[5px] mx-5 md:mx-0 absolute left-0 md:left-[40%] top-[20%]"
